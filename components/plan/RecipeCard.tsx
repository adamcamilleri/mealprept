...
export default function RecipeCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-warmgray-200/80 overflow-hidden transition-shadow duration-200 hover:shadow-sm">
      <div className="p-5 sm:p-6">
        <div className="flex justify-between items-start gap-3">
          <div className="flex-1 min-w-0">
            <h3 className="text-base sm:text-lg font-semibold text-warmgray-800 leading-snug">
              {recipe.name}
            </h3>
            <p className="text-warmgray-400 text-sm mt-1 leading-relaxed">
              {recipe.description}
            </p>
            <div className="flex flex-wrap gap-x-3 gap-y-1 mt-2.5">
              <span className="text-xs text-warmgray-400 bg-warmgray-100/60 px-2 py-0.5 rounded-md">
                {recipe.cuisine}
              </span>
              <span className="text-xs text-warmgray-400 bg-warmgray-100/60 px-2 py-0.5 rounded-md">
        ...
        <button
          ...
          className="mt-4 text-coral-500 text-sm font-medium hover:text-coral-600 transition-colors flex items-center gap-1.5"
        >
